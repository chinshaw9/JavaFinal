...
Date: 5/15/22
Program Name: Fun.java
Description: Fun quiz page
*/
...
public class Fun implements ActionListener{
	...
	JLabel label = new JLabel("Welcom to the Educational Quiz Page!");

	String[] questions = 	{

			"Which legendary Mall opened in 1992?",
			"What was the best-selling video game console?",
	...
	String[][] options = 	{
			...
			{"Caslteton Mall","Mall of America", "Circle Center Mall", "Dallas Mall"},
			{"Sony Playstation","Super Nintendo", "Xbox", "Game gear"},
			{"Golden Eye","Final Fantasy", "Mario Kart", "Tetris"},
			{"7.25", ".25", "4.25", "5.50"}
	...
	public Fun() {
		...
		frame1.add(time_label);

		frame1.add(seconds_left);

		frame1.add(answer_labelA);

		frame1.add(answer_labelB);

		frame1.add(answer_labelC);

		frame1.add(answer_labelD);
	...
	public void results(){
		...
		frame1.add(number_right);

		frame1.add(percentage);
